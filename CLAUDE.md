...
- Named patterns: `--pattern mangadex|mangafire|animeSama` for different filename conventions
...
- **Named regex patterns** centralized in `core.py` (`NAMED_PATTERNS` dict) — `mangadex`, `mangafire`, `animeSama`
