import re
from packer.core import extract_chapter_number, _match_extra, _match_chapter
...
def test_match_extra_and_chapter_helpers():
    ...
    assert extract_chapter_number('Ch.013.5.cbz', chapter_pat=ch_pat, extra_pat=ex_pat) == [(13, '5')]

    # chapter only
    assert extract_chapter_number('Ch.013.cbz', chapter_pat=ch_pat, extra_pat=ex_pat) == [(13, None)]
